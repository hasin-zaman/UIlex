const AnimatedInputCode =
 `export default function AnimatedInput({ borderRadius = "rounded-lg", borderColor = "border-blue-500", borderText = "text-blue-500", lineColor = "bg-blue-400" }) {
  return (
    <div className="flex items-center justify-center min-h-screen">
      ...
      >
        ...
        <label
          htmlFor="input"
          className={\`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 \${borderText} transition-all duration-300 ease-in-out pointer-events-none peer-focus:top-[-20px] peer-focus:left-1/2 peer-focus:-translate-x-1/2 peer-focus:text-blue-800 peer-focus:text-base peer-valid:top-[-20px] peer-valid:left-1/2 peer-valid:-translate-x-1/2 peer-valid:text-blue-800 peer-valid:text-base\`}
        >
          Write Text Here
        </label>
...
export { AnimatedInputCode, AnimatedInputUsage }